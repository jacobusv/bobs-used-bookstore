...
namespace Bookstore.Data
{
    public partial class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Note: No bool properties requiring HasConversion<int>() were found.
            // Address.IsActive and ShoppingCartItem.WantToBuy are stored as int in the entity model.
            // Book.IsInStock and Book.IsLowInStock are computed properties (excluded from column mappings).
